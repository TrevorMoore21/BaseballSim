...
public class FSimPinkerton
	{
				...
				public static void regPinkertonGame()
					{
						
						do
							{
								regPinkertonInningT1();
								regPinkertonInningB1();
						...
						if(PrunZ1 > OrunZ1)
							...
							{
								System.out.println("*&@^@#$(* " + "you lose " + BPlayerInfo.playerName + ", Pinkertons win");
								
								
								BPlayerInfo.playerMoney -= charlieBrown;
								finalSum = ((moneyTracker - charlieBrown)*-1);
								System.out.println("You have to pay $" + charlieBrown + " to the Pinkertons :(");
								finalSum *= -1;
							}
				...
				public static void qPinkertonGame()
					{
				...
				public static void regPinkertonInningT1()
					{
					...
					//Starting Pitching length
						if(BTeams.pinkertonStarter.get(0).getRarity().equals("Bronze"))
							{
								int Pinnings = (int) (Math.random() * 5) + 3;
							}
						else if(BTeams.pinkertonStarter.get(0).getRarity().equals("Silver"))
							{
								int Pinnings = (int) (Math.random() * 7) + 4;
							}
						else if(BTeams.pinkertonStarter.get(0).getRarity().equals("Gold"))
							{
								int Pinnings = (int) (Math.random() * 8) + 6;
							}
						else if(BTeams.pinkertonStarter.get(0).getRarity().equals("Platinum"))
							{
								...
								if (inningN <= pInnings)
									{
											...
											battingAvA = ((double) ((BBSPitchers) BTeams.pinkertonStarter.get(0)).getHitsAllowed()) / ((double) ((BBSPitchers) BTeams.pinkertonStarter.get(0)).getBattersFaced() 
														- (double) ((BBSPitchers) BTeams.pinkertonStarter.get(0)).getWalks() - (double) ((BBSPitchers) BTeams.pinkertonStarter.get(0)).getHitByPitch());
											...
											double newWalks = (((double) ((BBSPitchers) BTeams.pinkertonStarter.get(0)).getWalks() / ((BBSPitchers) BTeams.pinkertonStarter.get(0)).getBattersFaced()) * 1000);
								
											double newHitByPitch = (((double) ((BBSPitchers) BTeams.pinkertonStarter.get(0)).getHitByPitch() / ((BBSPitchers) BTeams.pinkertonStarter.get(0)).getBattersFaced()) * 1000);
										...
										if(relieverO < 6)
											{
												...
												battingAvA = ((double) ((BBSPitchers) BTeams.pinkertonReliever.get(relieverNum1)).getHitsAllowed()) / ((double) ((BBSPitchers) BTeams.pinkertonReliever.get(relieverNum1)).getBattersFaced() 
															- (double) ((BBSPitchers) BTeams.pinkertonReliever.get(relieverNum1)).getWalks() - (double) ((BBSPitchers) BTeams.pinkertonReliever.get(relieverNum1)).getHitByPitch());
												...
												double newWalks = (((double) ((BBSPitchers) BTeams.pinkertonReliever.get(relieverNum1)).getWalks() / ((BBSPitchers) BTeams.pinkertonReliever.get(relieverNum1)).getBattersFaced()) * 1000);
									
												double newHitByPitch = (((double) ((BBSPitchers) BTeams.pinkertonReliever.get(relieverNum1)).getHitByPitch() / ((BBSPitchers) BTeams.pinkertonReliever.get(relieverNum1)).getBattersFaced()) * 1000);
				...
				public static void regPinkertonInningB1()
				{
				...
				//Starting Pitching length
					...
					do 
						...
						//enter starters	
							if (inningN <= pInnings)
								{
										battingAv = (double) ((BBSHitters) BTeams.pinkertonLinup.get(playerNum2)).getHits() / ((BBSHitters) BTeams.pinkertonLinup.get(playerNum2)).getAtBats(); 
										...
										double newHR = (double) (((BBSHitters) BTeams.pinkertonLinup.get(playerNum2)).getHomeRuns() / ((BBSHitters) BTeams.pinkertonLinup.get(playerNum2)).getAtBats() * 1000);
				...
				public static void qPinkertonInningT1()
					{
				...
				public static void qPinkertonInningB1()
					{
