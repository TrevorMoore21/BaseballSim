								...
								if (menuNum.equals("4"))
									{
										...
										System.out.println(BPlayerInfo.playerName + ", your new balance is $" + BPlayerInfo.playerMoney);
