...
public class FSimElFart
	{
				...
				public static void regFartGame()
					{
						...
						if(PrunZ1 > OrunZ1)
							...
							{
								System.out.println("*&@^@#$(* " + "you lose " + BPlayerInfo.playerName + ", El Farts win");
								
								
								BPlayerInfo.playerMoney -= charlieBrown;
								finalSum = ((moneyTracker - charlieBrown)*-1);
								System.out.println("You have to pay $" + charlieBrown + " to the El Farts :(");
								finalSum *= -1;
							}
				...
				public static void regFartInningT1()
					{
					...
					//Starting Pitching length
						if(BTeams.elfartStarter.get(0).getRarity().equals("Bronze"))
							{
								int Pinnings = (int) (Math.random() * 5) + 3;
							}
						else if(BTeams.elfartStarter.get(0).getRarity().equals("Silver"))
							{
								int Pinnings = (int) (Math.random() * 7) + 4;
							}
						else if(BTeams.elfartStarter.get(0).getRarity().equals("Gold"))
							{
								int Pinnings = (int) (Math.random() * 8) + 6;
							}
						else if(BTeams.elfartStarter.get(0).getRarity().equals("Platinum"))
							{
								...
								if (inningN <= pInnings)
									{
											...
											battingAvA = ((double) ((BBSPitchers) BTeams.elfartStarter.get(0)).getHitsAllowed()) / ((double) ((BBSPitchers) BTeams.elfartStarter.get(0)).getBattersFaced() 
														- (double) ((BBSPitchers) BTeams.elfartStarter.get(0)).getWalks() - (double) ((BBSPitchers) BTeams.elfartStarter.get(0)).getHitByPitch());
											...
											double newWalks = (((double) ((BBSPitchers) BTeams.elfartStarter.get(0)).getWalks() / ((BBSPitchers) BTeams.elfartStarter.get(0)).getBattersFaced()) * 1000);
								
											double newHitByPitch = (((double) ((BBSPitchers) BTeams.elfartStarter.get(0)).getHitByPitch() / ((BBSPitchers) BTeams.elfartStarter.get(0)).getBattersFaced()) * 1000);
										...
										if(relieverO < 6)
											{
												...
												battingAvA = ((double) ((BBSPitchers) BTeams.elfartReliever.get(relieverNum1)).getHitsAllowed()) / ((double) ((BBSPitchers) BTeams.elfartReliever.get(relieverNum1)).getBattersFaced() 
															- (double) ((BBSPitchers) BTeams.elfartReliever.get(relieverNum1)).getWalks() - (double) ((BBSPitchers) BTeams.elfartReliever.get(relieverNum1)).getHitByPitch());
												...
												double newWalks = (((double) ((BBSPitchers) BTeams.elfartReliever.get(relieverNum1)).getWalks() / ((BBSPitchers) BTeams.elfartReliever.get(relieverNum1)).getBattersFaced()) * 1000);
									
												double newHitByPitch = (((double) ((BBSPitchers) BTeams.elfartReliever.get(relieverNum1)).getHitByPitch() / ((BBSPitchers) BTeams.elfartReliever.get(relieverNum1)).getBattersFaced()) * 1000);
				...
				public static void regFartInningB1()
				{
				...
				//Starting Pitching length
					...
					do 
						...
						//enter starters	
							if (inningN <= pInnings)
								{
										battingAv = (double) ((BBSHitters) BTeams.elfartLinup.get(playerNum2)).getHits() / ((BBSHitters) BTeams.elfartLinup.get(playerNum2)).getAtBats(); 
										...
										double newHR = (double) (((BBSHitters) BTeams.elfartLinup.get(playerNum2)).getHomeRuns() / ((BBSHitters) BTeams.elfartLinup.get(playerNum2)).getAtBats() * 1000);
				...
				public static void qFartInningT1()
					{
				...
				public static void qFartInningB1()
					{
