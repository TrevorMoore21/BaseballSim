...
public class FSimChicharron
	{
				...
				public static void regChicharronGame()
					{
						
						do
							{
								regChicharronInningT1();
								regChicharronInningB1();
						...
						if(PrunZ1 > OrunZ1)
							...
							{
								System.out.println("*&@^@#$(* " + "you lose " + BPlayerInfo.playerName + ", Chicharrones win");
								
								
								BPlayerInfo.playerMoney -= charlieBrown;
								finalSum = ((moneyTracker - charlieBrown)*-1);
								System.out.println("You have to pay $" + charlieBrown + " to the Chicharrones :(");
								finalSum *= -1;
							}
				...
				public static void qChicharronGame()
					{
				...
				//money from pitching		
						...
						if(Pruns > Oruns)
							...
							{
								System.out.println("You lose " + BPlayerInfo.playerName + ", Chicharron win");
								
								
								int charlieBrown = (int) (Math.random() * 216) + 104;
								moneyFinal -= charlieBrown;
								BPlayerInfo.playerMoney -= charlieBrown;
								System.out.println("*&@^@#$(* " + "You have to pay $" + charlieBrown + " to the Chicharron :(");
							}
				...
				public static void regChicharronInningT1()
					{
					...
					//Starting Pitching length
						if(BTeams.chicharronStarter.get(0).getRarity().equals("Bronze"))
							{
								int Pinnings = (int) (Math.random() * 5) + 3;
							}
						else if(BTeams.chicharronStarter.get(0).getRarity().equals("Silver"))
							{
								int Pinnings = (int) (Math.random() * 7) + 4;
							}
						else if(BTeams.chicharronStarter.get(0).getRarity().equals("Gold"))
							{
								int Pinnings = (int) (Math.random() * 8) + 6;
							}
						else if(BTeams.chicharronStarter.get(0).getRarity().equals("Platinum"))
							{
								...
								if (inningN <= pInnings)
									{
											...
											battingAvA = ((double) ((BBSPitchers) BTeams.chicharronStarter.get(0)).getHitsAllowed()) / ((double) ((BBSPitchers) BTeams.chicharronStarter.get(0)).getBattersFaced() 
														- (double) ((BBSPitchers) BTeams.chicharronStarter.get(0)).getWalks() - (double) ((BBSPitchers) BTeams.chicharronStarter.get(0)).getHitByPitch());
											...
											double newWalks = (((double) ((BBSPitchers) BTeams.chicharronStarter.get(0)).getWalks() / ((BBSPitchers) BTeams.chicharronStarter.get(0)).getBattersFaced()) * 1000);
								
											double newHitByPitch = (((double) ((BBSPitchers) BTeams.chicharronStarter.get(0)).getHitByPitch() / ((BBSPitchers) BTeams.chicharronStarter.get(0)).getBattersFaced()) * 1000);
										...
										if(relieverO < 6)
											{
												...
												battingAvA = ((double) ((BBSPitchers) BTeams.chicharronReliever.get(relieverNum1)).getHitsAllowed()) / ((double) ((BBSPitchers) BTeams.chicharronReliever.get(relieverNum1)).getBattersFaced() 
															- (double) ((BBSPitchers) BTeams.chicharronReliever.get(relieverNum1)).getWalks() - (double) ((BBSPitchers) BTeams.chicharronReliever.get(relieverNum1)).getHitByPitch());
												...
												double newWalks = (((double) ((BBSPitchers) BTeams.chicharronReliever.get(relieverNum1)).getWalks() / ((BBSPitchers) BTeams.chicharronReliever.get(relieverNum1)).getBattersFaced()) * 1000);
									
												double newHitByPitch = (((double) ((BBSPitchers) BTeams.chicharronReliever.get(relieverNum1)).getHitByPitch() / ((BBSPitchers) BTeams.chicharronReliever.get(relieverNum1)).getBattersFaced()) * 1000);
				...
				public static void regChicharronInningB1()
				{
				...
				//Starting Pitching length
					...
					do 
						...
						//enter starters	
							if (inningN <= pInnings)
								{
										battingAv = (double) ((BBSHitters) BTeams.chicharronLinup.get(playerNum2)).getHits() / ((BBSHitters) BTeams.chicharronLinup.get(playerNum2)).getAtBats(); 
										...
										double newHR = (double) (((BBSHitters) BTeams.chicharronLinup.get(playerNum2)).getHomeRuns() / ((BBSHitters) BTeams.chicharronLinup.get(playerNum2)).getAtBats() * 1000);
				...
				public static void qChicharronInningT1()
					{
				...
				public static void qChicharronInningB1()
					{
