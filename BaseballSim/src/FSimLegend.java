...
public class FSimLegend
	{
				...
				public static void regLegendGame()
					{
						...
						if(PrunZ1 > OrunZ1)
							...
							{
								System.out.println("*&@^@#$(* " + "you lose " + BPlayerInfo.playerName + ", Legends win");
								
								
								BPlayerInfo.playerMoney -= charlieBrown;
								finalSum = ((moneyTracker - charlieBrown)*-1);
								System.out.println("You have to pay $" + charlieBrown + " to the Legends :(");
								finalSum *= -1;
							}
				...
				public static void qLegendGame()
					{
				...
				public static void regLegendInningT1()
					{
					...
					//Starting Pitching length
						if(BTeams.legendStarter.get(0).getRarity().equals("Bronze"))
							{
								int Pinnings = (int) (Math.random() * 5) + 3;
							}
						else if(BTeams.legendStarter.get(0).getRarity().equals("Silver"))
							{
								int Pinnings = (int) (Math.random() * 7) + 4;
							}
						else if(BTeams.legendStarter.get(0).getRarity().equals("Gold"))
							{
								int Pinnings = (int) (Math.random() * 8) + 6;
							}
						else if(BTeams.legendStarter.get(0).getRarity().equals("Platinum"))
							{
								...
								if (inningN <= pInnings)
									{
											...
											battingAvA = ((double) ((BBSPitchers) BTeams.legendStarter.get(0)).getHitsAllowed()) / ((double) ((BBSPitchers) BTeams.legendStarter.get(0)).getBattersFaced() 
														- (double) ((BBSPitchers) BTeams.legendStarter.get(0)).getWalks() - (double) ((BBSPitchers) BTeams.legendStarter.get(0)).getHitByPitch());
											...
											double newWalks = (((double) ((BBSPitchers) BTeams.legendStarter.get(0)).getWalks() / ((BBSPitchers) BTeams.legendStarter.get(0)).getBattersFaced()) * 1000);
								
											double newHitByPitch = (((double) ((BBSPitchers) BTeams.legendStarter.get(0)).getHitByPitch() / ((BBSPitchers) BTeams.legendStarter.get(0)).getBattersFaced()) * 1000);
										...
										if(relieverO < 6)
											{
												...
												battingAvA = ((double) ((BBSPitchers) BTeams.legendReliever.get(relieverNum1)).getHitsAllowed()) / ((double) ((BBSPitchers) BTeams.legendReliever.get(relieverNum1)).getBattersFaced() 
															- (double) ((BBSPitchers) BTeams.legendReliever.get(relieverNum1)).getWalks() - (double) ((BBSPitchers) BTeams.legendReliever.get(relieverNum1)).getHitByPitch());
												...
												double newWalks = (((double) ((BBSPitchers) BTeams.legendReliever.get(relieverNum1)).getWalks() / ((BBSPitchers) BTeams.legendReliever.get(relieverNum1)).getBattersFaced()) * 1000);
									
												double newHitByPitch = (((double) ((BBSPitchers) BTeams.legendReliever.get(relieverNum1)).getHitByPitch() / ((BBSPitchers) BTeams.legendReliever.get(relieverNum1)).getBattersFaced()) * 1000);
				...
				public static void regLegendInningB1()
				{
				...
				//Starting Pitching length
					...
					do 
						...
						//enter starters	
							if (inningN <= pInnings)
								{
										battingAv = (double) ((BBSHitters) BTeams.legendLinup.get(playerNum2)).getHits() / ((BBSHitters) BTeams.legendLinup.get(playerNum2)).getAtBats(); 
										...
										double newHR = (double) (((BBSHitters) BTeams.legendLinup.get(playerNum2)).getHomeRuns() / ((BBSHitters) BTeams.legendLinup.get(playerNum2)).getAtBats() * 1000);
				...
				public static void qLegendInningT1()
					{
				...
				public static void qLegendInningB1()
					{
